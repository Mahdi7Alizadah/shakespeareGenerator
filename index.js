...
window.onload = function () { 
    let quoteButton = document.querySelector(".quote-box .button");
    let text = document.querySelector(".quote-box__quote");
    let author = document.querySelector(".quote-box__author");
  
quoteButton.addEventListener('click', () => {
        let index = Math.floor(Math.random() * quotes.length); 
        text.innerHTML = quotes[index].insult;
        author.innerHTML = `-${quotes[index].play}`;
